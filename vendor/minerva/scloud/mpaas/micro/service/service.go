...
// NewServerService generate a micro service by config file
// the service is used by server
// @configFile: config file name(format:ini)
...
// @optConfs: optional config item,the same with server config file's item
